...
const routerControl = Object.freeze({
  ...
  getClaudeAccountPool: () => call("getClaudeAccountPool"),
  ...
  setEngineeringRole: (role, candidates, optionalCandidates, revision, reset = false) =>
    call("setEngineeringRole", { role, candidates, optionalCandidates, revision, reset }),
  setEngineeringLead: (model, effort, revision) => call("setEngineeringLead", { model, effort, revision }),
  ...
  addClaudeSubscriptionAccount: (label) => call("addClaudeSubscriptionAccount", { label }),
  loginClaudeSubscriptionAccount: (accountId) => call("loginClaudeSubscriptionAccount", { accountId }),
