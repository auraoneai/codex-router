...
function unit() {
  ...
  const environment = {
    ...
    CODEX_ROUTER_COMPACTION_DEADLINE_MS:
      process.env.CODEX_ROUTER_COMPACTION_DEADLINE_MS || "170000",
    CODEX_ROUTER_COMPACTION_ATTEMPT_DEADLINE_MS:
      process.env.CODEX_ROUTER_COMPACTION_ATTEMPT_DEADLINE_MS || "80000",
    CODEX_ROUTER_COMPACTION_FIRST_EVENT_DEADLINE_MS:
      process.env.CODEX_ROUTER_COMPACTION_FIRST_EVENT_DEADLINE_MS || "30000",
    CODEX_ROUTER_COMPACTION_PROGRESS_IDLE_DEADLINE_MS:
      process.env.CODEX_ROUTER_COMPACTION_PROGRESS_IDLE_DEADLINE_MS || "30000",
